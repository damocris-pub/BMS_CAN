...
ZCAN_DT_ZCAN_LIN_ERROR_DATA = 6
ZCAN_DT_ZCAN_LIN_EX_DATA    = 7
ZCAN_DT_ZCAN_LIN_EVENT_DATA = 8

ZCAN_TX_DELAY_NO_DELAY   = 0
ZCAN_TX_DELAY_UNIT_MS    = 1
ZCAN_TX_DELAY_UNIT_100US = 2
...
class ZCANFD_AUTO_TRANSMIT_OBJ_PARAM(Structure):
...
def ZCAN_DYNAMIC_CONFIG_CAN_BUSRATIO_ENABLE(can_id):
    return f"DYNAMIC_CONFIG_CAN{can_id}_BUSRATIO_ENABLE"
